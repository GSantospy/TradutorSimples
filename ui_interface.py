...
################################################################################
## Form generated from reading UI file 'interfaceVgmfQd.ui'
##
...
"border-color: #d9d9d9;")
        ...
        self.cb_detectar.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
...
"            }")
        ...
        self.horizontalLayout_2.addWidget(self.cb_detectar, 0, Qt.AlignmentFlag.AlignLeft)

        self.btn_trocar_lang = QPushButton(self.widget)
        self.btn_trocar_lang.setObjectName(u"btn_trocar_lang")
        self.btn_trocar_lang.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
...
"}")
        icon = QIcon()
        icon.addFile(u":/icones/trocar.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_trocar_lang.setIcon(icon)
        self.btn_trocar_lang.setIconSize(QSize(20, 20))

        self.horizontalLayout_2.addWidget(self.btn_trocar_lang, 0, Qt.AlignmentFlag.AlignHCenter)
        ...
        self.cb_traduzido.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
...
"            }")
        ...
        self.horizontalLayout_2.addWidget(self.cb_traduzido, 0, Qt.AlignmentFlag.AlignRight)
...
"color: black;")
        ...
        self.btn_traduzir.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
...
"border: 1px solid #b9b9b9;")
        ...
        self.btn_traduzir.raise_()
        self.pte_traduzido.raise_()
        self.pte_traduzir.raise_()
        ...
        self.btn_copiar_traduzido.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
...
"}")
        icon1 = QIcon()
        icon1.addFile(u":/icones/copiar.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.cb_traduzido.setItemText(0, QCoreApplication.translate("MainWindow", u"Portugu\u00eas", None))
        self.cb_traduzido.setItemText(1, QCoreApplication.translate("MainWindow", u"Ingl\u00eas", None))
